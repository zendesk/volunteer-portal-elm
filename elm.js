...
var _user$project$SharedStyles$portalNamespace = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('portal');
var _user$project$SharedStyles$NavBar = {ctor: 'NavBar'};
var _user$project$SharedStyles$Content = {ctor: 'Content'};

var _user$project$VolunteerPortalCss$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, _user$project$SharedStyles$portalNamespace.name, _p0));
}(
	{
		ctor: '::',
		...
		_1: {
			...
			_0: A2(
				...
				_user$project$SharedStyles$Content,
				{
					ctor: '::',
					...
					_1: {
						...
						_0: _rtfeldman$elm_css$Css$width(
							_rtfeldman$elm_css$Css$px(1000)),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
				...
				_0: A2(
					...
					_user$project$SharedStyles$NavBar,
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$displayFlex,
						_1: {
							ctor: '::',
							_0: A2(_rtfeldman$elm_css$Css$property, 'justify-content', 'space-around'),
							_1: {
								ctor: '::',
...
var _user$project$VolunteerPortal$_p0 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('portal');
var _user$project$VolunteerPortal$id = _user$project$VolunteerPortal$_p0.id;
var _user$project$VolunteerPortal$class = _user$project$VolunteerPortal$_p0.$class;
var _user$project$VolunteerPortal$classList = _user$project$VolunteerPortal$_p0.classList;
var _user$project$VolunteerPortal$header = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _user$project$VolunteerPortal$class(
			{
				ctor: '::',
				_0: _user$project$SharedStyles$Content,
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$src('https://d1eipm3vz40hy0.cloudfront.net/images/p-brand/zendesk-wordmark.svg'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$height(35),
					_1: {ctor: '[]'}
				}
			},
			{ctor: '[]'}),
...
var _user$project$VolunteerPortal$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$VolunteerPortal$class(
				{
					ctor: '::',
					_0: _user$project$SharedStyles$NavBar,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$VolunteerPortal$header,
			_1: {ctor: '[]'}
		});
};
var _user$project$VolunteerPortal$main = _elm_lang$virtual_dom$Native_VirtualDom.staticProgram(
	_user$project$VolunteerPortal$view('no model yet'));

var Elm = {};
Elm['VolunteerPortal'] = Elm['VolunteerPortal'] || {};
if (typeof _user$project$VolunteerPortal$main !== 'undefined') {
    _user$project$VolunteerPortal$main(Elm['VolunteerPortal'], 'VolunteerPortal', undefined);
}
